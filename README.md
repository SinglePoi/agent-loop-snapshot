...
The project is open source on [GitHub](https://github.com/SinglePoi/agent-loop-snapshot), and its core packages are published to npm. The current public release is `0.1.1`.
